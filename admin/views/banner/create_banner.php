...
<head>
    ...
    <meta charset="utf-8" />
    <title>Thêm banner | NN Shop</title>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="name" class="form-control" placeholder="Tên slide" name='ten_danh_muc_banner'>
                                                                <span class="text-danger">
                                                                    <?= !empty($_SESSION["errors"]['ten_danh_muc_banner']) ? $_SESSION["errors"]['ten_danh_muc_banner'] : '' ?>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class=" col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="file" class="form-control" placeholder="Image" name='link_hinh_anh' id="citynameInput">
                                                                <span class="text-danger">
                                                                    <?= !empty($_SESSION["errors"]['link_hinh_anh']) ? $_SESSION["errors"]['link_hinh_anh'] : '' ?>
                                                                </span>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="date" class="form-control" placeholder="Image" id="citynameInput" name="ngay_tao">
                                                                <span class="text-danger">
