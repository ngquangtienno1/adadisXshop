                                    ...
                                    <div class="card-body">
                                        <div class="live-preview">
                                            <form action="?act=sua-nguoi-dung" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="id" value="<?php $nguoiDung['id'] ?>">
                                                <div class="row">
                                                    <!--end col-->
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="compnayNameinput" class="form-label">Tên người dùng</label>
                                                            <input type="text" class="form-control" placeholder="Nhập tên người dùng" name="ten_nguoi_dung" value="<?php $nguoiDung['ten_nguoi_dung'] ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="tel" class="form-control" placeholder="+(245) 451 45123" name="sdt" value="<?php $nguoiDung['sdt'] ?>">
                                                            <span class="text-danger">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control" placeholder="example@gamil.com" name="email" value="<?php $nguoiDung['email'] ?>">
                                                            <span class="text-danger">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div>
                                                            ...
                                                            <input type="password" class="form-control" name="mat_khau" placeholder="Password" value="<?php $nguoiDung['mat_khau'] ?>">
                                                            <span class="text-danger">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" class="form-control" placeholder="Enter your date" name="ngay_sinh" value="<?php $nguoiDung['ngay_sinh'] ?>">
                                                            <span class="text-danger">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="1234 Main St" name="dia_chi" value="<?php $nguoiDung['dia_chi'] ?>">
                                                            <span class="text-danger">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="gioi_tinh" id="gioi_tinh" class="form-control" value="<?php $nguoiDung['gioi_tinh'] ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="file" name="avatar" id="avatar" class="form-control" value="<?php $nguoiDung['avatar'] ?>" >
                                                            <span class="text-danger">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="vai_tro" id="role" class="form-control" value="<?php $nguoiDung['vai_tro'] ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="date" name="ngay_tao" id="created_at" class="form-control" value="<?php $nguoiDung['ngay_tao'] ?>">
                                                            <span class="text-danger">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" class="form-control"  name="ngay_cap_nhat" value="<?php $nguoiDung['ngay_cap_nhat'] ?>">
                                                            <span class="text-danger">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="trang_thai" id="ForminputState" class="form-select" value="<?php $nguoiDung['trang_thai'] ?>">
