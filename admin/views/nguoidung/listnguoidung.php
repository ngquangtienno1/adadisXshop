                                        ...
                                        <div class="live-preview">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-nowrap align-middle mb-0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        foreach ($danhSachNguoiDung as $key => $nguoiDung) { ?>
                                                            <tr>
                                                                ...
                                                                <td><img src="<?= $nguoiDung['avatar'] ?>" alt="" width="100px"></td>
                                                                <td>
                                                                    <?php if ($nguoiDung['vai_tro']) {?>
                                                                ...
                                                                <td>
                                                                    <div class="hstack gap-3 flex-wrap">
                                                                        <a href="?act=form-update-nguoi-dung&nguoi_dung_id=<?= $nguoiDung['id'] ?>" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>

                                                                        <form action="?act=xoa-nguoi-dung" method="POST" onsubmit="return confirm('Bạn có đồng ý xóa không?')">
