                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Nhập tên liên hệ" name="ten" value="<?= $lienHe['ten']?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="tel" class="form-control" placeholder="+(245) 451 45123" name="so_dien_thoai" value="<?= $lienHe['so_dien_thoai']?>">
                                                            <span class="text-danger">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control" placeholder="example@gamil.com" name="email"  value="<?= $lienHe['email']?>">
                                                            <span class="text-danger">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div>
                                                            ...
                                                            <input type="datetime-local" class="form-control" name="ngay_tao" value="<?= $lienHe['ngay_tao']?>">
                                                            <span class="text-danger">
